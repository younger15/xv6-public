...
int main(int argc, char *argv[])
{
  20:	89 85 6c fb ff ff    	mov    %eax,-0x494(%ebp)
	...
	int co = changeOwner(argv[1], argv[2]);
  26:	e8 97 06 00 00       	call   6c2 <changeOwner>
	if(co == 0)
  ...
  30:	74 05                	je     37 <main+0x37>
	...
	exit();
  32:	e8 cb 05 00 00       	call   602 <exit>
  ...
  38:	53                   	push   %ebx
  39:	6a 00                	push   $0x0
  3b:	68 90 0a 00 00       	push   $0xa90
  40:	e8 fd 05 00 00       	call   642 <open>
		if(fd >= 0)
  ...
  62:	e8 b3 05 00 00       	call   61a <read>
  67:	89 c7                	mov    %eax,%edi
			close(fd);
  69:	89 34 24             	mov    %esi,(%esp)
  6c:	e8 b9 05 00 00       	call   62a <close>
			if(n >= 0)
  71:	83 c4 10             	add    $0x10,%esp
  74:	85 ff                	test   %edi,%edi
  76:	0f 88 93 01 00 00    	js     20f <main+0x20f>
  ...
  94:	0f 84 86 01 00 00    	je     220 <main+0x220>
  ...
  eb:	e8 50 03 00 00       	call   440 <strlen>
					i--;
					int s = 0;
 ...
 1c8:	00 
				...
				printf(1,"buf: %s\n",buf);
 1c9:	8b bd 74 fb ff ff    	mov    -0x48c(%ebp),%edi
 1cf:	56                   	push   %esi
 1d0:	57                   	push   %edi
 1d1:	68 9d 0a 00 00       	push   $0xa9d
 1d6:	6a 01                	push   $0x1
 1d8:	e8 93 05 00 00       	call   770 <printf>
				fd = open("FileAppendix", O_RDWR);
 1dd:	58                   	pop    %eax
 1de:	5a                   	pop    %edx
 1df:	6a 02                	push   $0x2
 1e1:	68 90 0a 00 00       	push   $0xa90
 1e6:	e8 57 04 00 00       	call   642 <open>
				if(fd >= 0)
 ...
 1f0:	89 c6                	mov    %eax,%esi
				if(fd >= 0)
 1f2:	78 1b                	js     20f <main+0x20f>
				{
					int m = write(fd, buf, sizeof buf);
 1f4:	53                   	push   %ebx
 1f5:	68 00 04 00 00       	push   $0x400
 1fa:	57                   	push   %edi
 1fb:	50                   	push   %eax
 1fc:	e8 21 04 00 00       	call   622 <write>
					//printf(1, "co: writing: %d %d\n", m, sizeof buf);
					if(m == sizeof buf)
 201:	83 c4 10             	add    $0x10,%esp
 204:	3d 00 04 00 00       	cmp    $0x400,%eax
 209:	0f 84 85 01 00 00    	je     394 <main+0x394>
						close(fd);
 ...
 21b:	e9 12 fe ff ff       	jmp    32 <main+0x32>
					i++;
					if (c == ':')
					{
						...
						// compare with argv[1]
						char* k = argv[1];
 220:	8b 9d 6c fb ff ff    	mov    -0x494(%ebp),%ebx
						char* l = fileNameBuf;
						while (j > 0 && *k && *k == *l)
 226:	85 c9                	test   %ecx,%ecx
					...
					if (c == ':')
					{
						...
						// compare with argv[1]
						char* k = argv[1];
 228:	8b 7b 04             	mov    0x4(%ebx),%edi
						char* l = fileNameBuf;
						while (j > 0 && *k && *k == *l)
 22b:	0f 84 ca 00 00 00    	je     2fb <main+0x2fb>
 231:	0f b6 17             	movzbl (%edi),%edx
 234:	84 d2                	test   %dl,%dl
 236:	0f 84 8c 00 00 00    	je     2c8 <main+0x2c8>
 23c:	38 95 88 fb ff ff    	cmp    %dl,-0x478(%ebp)
 242:	0f 85 80 00 00 00    	jne    2c8 <main+0x2c8>
 248:	8d 57 01             	lea    0x1(%edi),%edx
 24b:	89 c6                	mov    %eax,%esi
 24d:	01 cf                	add    %ecx,%edi
 24f:	8d 8d 88 fb ff ff    	lea    -0x478(%ebp),%ecx
 255:	eb 17                	jmp    26e <main+0x26e>
 257:	89 f6                	mov    %esi,%esi
 259:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
 260:	0f b6 02             	movzbl (%edx),%eax
 263:	84 c0                	test   %al,%al
 265:	74 58                	je     2bf <main+0x2bf>
 267:	83 c2 01             	add    $0x1,%edx
 26a:	3a 01                	cmp    (%ecx),%al
 26c:	75 51                	jne    2bf <main+0x2bf>
						{
							k++;
							l++;
 ...
 273:	75 eb                	jne    260 <main+0x260>
 275:	8b 9d 70 fb ff ff    	mov    -0x490(%ebp),%ebx
 27b:	89 f0                	mov    %esi,%eax
 27d:	0f b6 8c 1d e8 fb ff 	movzbl -0x418(%ebp,%ebx,1),%ecx
 284:	ff 
 285:	8b 9d 70 fb ff ff    	mov    -0x490(%ebp),%ebx
 28b:	8d 73 01             	lea    0x1(%ebx),%esi
						}
						if (j == 0) 
						{
							// found file
							...
							while (buf[i] != ':')
 28e:	80 f9 3a             	cmp    $0x3a,%cl
 291:	74 75                	je     308 <main+0x308>
 293:	8b bd 74 fb ff ff    	mov    -0x48c(%ebp),%edi
							{
								int m = i;
								
								while(buf[m] != '\0')
 299:	84 c9                	test   %cl,%cl
 29b:	8d 14 37             	lea    (%edi,%esi,1),%edx
 29e:	74 f3                	je     293 <main+0x293>
								{
									buf[m] = buf[m+1];
 2a0:	0f b6 0a             	movzbl (%edx),%ecx
 2a3:	83 c2 01             	add    $0x1,%edx
 2a6:	88 4a fe             	mov    %cl,-0x2(%edx)
							// kill original owner name
							while (buf[i] != ':')
							{
								int m = i;
								...
								while(buf[m] != '\0')
 2a9:	80 7a ff 00          	cmpb   $0x0,-0x1(%edx)
 2ad:	75 f1                	jne    2a0 <main+0x2a0>
 2af:	8b 9d 70 fb ff ff    	mov    -0x490(%ebp),%ebx
 2b5:	0f b6 8c 1d e8 fb ff 	movzbl -0x418(%ebp,%ebx,1),%ecx
 2bc:	ff 
 2bd:	eb cf                	jmp    28e <main+0x28e>
 ...
 2c1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
						{
							...
							{		
							c = buf[i];
 2c8:	8b bd 74 fb ff ff    	mov    -0x48c(%ebp),%edi
 2ce:	0f b6 14 07          	movzbl (%edi,%eax,1),%edx
							i++;
 2d2:	83 c0 01             	add    $0x1,%eax
							} while (c != ':');
 2d5:	80 fa 3a             	cmp    $0x3a,%dl
 2d8:	75 ee                	jne    2c8 <main+0x2c8>
 2da:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
							do
							{
								c = buf[i];
 2e0:	8b b5 74 fb ff ff    	mov    -0x48c(%ebp),%esi
 2e6:	0f b6 14 06          	movzbl (%esi,%eax,1),%edx
								i++;
 2ea:	83 c0 01             	add    $0x1,%eax
							} while (c != ':');
 2ed:	80 fa 3a             	cmp    $0x3a,%dl
 2f0:	75 ee                	jne    2e0 <main+0x2e0>
								
							
						}

						j = 0;
 2f2:	31 c9                	xor    %ecx,%ecx
 2f4:	89 c6                	mov    %eax,%esi
 2f6:	e9 85 fd ff ff       	jmp    80 <main+0x80>
 2fb:	0f b6 8c 05 e8 fb ff 	movzbl -0x418(%ebp,%eax,1),%ecx
 302:	ff 
 303:	e9 7d ff ff ff       	jmp    285 <main+0x285>
									buf[m] = buf[m+1];
									m++;
								}
							}
							...
							char* o = argv[2];
 308:	8b 9d 6c fb ff ff    	mov    -0x494(%ebp),%ebx
							int nameLen = 0;							
 30e:	31 f6                	xor    %esi,%esi
							...
							// insert new owner name
							char* o = argv[2];
 310:	8b 7b 08             	mov    0x8(%ebx),%edi
							int nameLen = 0;							
							while (*o)
 313:	eb 03                	jmp    318 <main+0x318>
							{
								o++;
								nameLen++;
 315:	83 c6 01             	add    $0x1,%esi
								}
							}
							// insert new owner name
							char* o = argv[2];
							int nameLen = 0;							
							while (*o)
 318:	80 3c 37 00          	cmpb   $0x0,(%edi,%esi,1)
 31c:	75 f7                	jne    315 <main+0x315>
							{
								o++;
								nameLen++;
							}
 ...
 320:	0f 84 a3 fe ff ff    	je     1c9 <main+0x1c9>
 326:	8b 9d 70 fb ff ff    	mov    -0x490(%ebp),%ebx
 32c:	8b 8d 74 fb ff ff    	mov    -0x48c(%ebp),%ecx
 332:	8d 4c 19 ff          	lea    -0x1(%ecx,%ebx,1),%ecx
 ...
 33a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
							...
							for (p = 0; p < nameLen; p++)
							{
								int q = i;
								while (buf[q]!='\0')
 340:	80 79 01 00          	cmpb   $0x0,0x1(%ecx)
 344:	89 c2                	mov    %eax,%edx
 346:	74 17                	je     35f <main+0x35f>
 348:	90                   	nop
 349:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 350:	8b 9d 74 fb ff ff    	mov    -0x48c(%ebp),%ebx
									q++;
 356:	83 c2 01             	add    $0x1,%edx
							...
							for (p = 0; p < nameLen; p++)
							{
								int q = i;
								while (buf[q]!='\0')
 359:	80 3c 13 00          	cmpb   $0x0,(%ebx,%edx,1)
 35d:	75 f1                	jne    350 <main+0x350>
									q++;
								q++;
								while(q > i)
 35f:	39 d0                	cmp    %edx,%eax
 361:	7f 1c                	jg     37f <main+0x37f>
 363:	03 95 74 fb ff ff    	add    -0x48c(%ebp),%edx
 ...
 373:	83 ea 01             	sub    $0x1,%edx
 376:	88 42 02             	mov    %al,0x2(%edx)
							{
								int q = i;
								while (buf[q]!='\0')
									q++;
 ...
 37d:	89 d8                	mov    %ebx,%eax
								...
								buf[i] = argv[2][p];  // insert the new name char								
 37f:	0f b6 14 07          	movzbl (%edi,%eax,1),%edx
								i++;
 ...
 389:	88 11                	mov    %dl,(%ecx)
							...
							int p = 0;
							for (p = 0; p < nameLen; p++)
 38b:	39 f0                	cmp    %esi,%eax
 38d:	75 b1                	jne    340 <main+0x340>
 38f:	e9 35 fe ff ff       	jmp    1c9 <main+0x1c9>
				{
					int m = write(fd, buf, sizeof buf);
					//printf(1, "co: writing: %d %d\n", m, sizeof buf);
					if(m == sizeof buf)
 ...
 397:	56                   	push   %esi
 398:	e8 8d 02 00 00       	call   62a <close>
						printf(1, "co: File owner changed succeed\n");
 39d:	5a                   	pop    %edx
 39e:	59                   	pop    %ecx
 39f:	68 a8 0a 00 00       	push   $0xaa8
 3a4:	6a 01                	push   $0x1
 3a6:	e8 c5 03 00 00       	call   770 <printf>
 3ab:	83 c4 10             	add    $0x10,%esp
 3ae:	e9 5c fe ff ff       	jmp    20f <main+0x20f>
...
putc(int fd, char c)
{
 ...
 888:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 88b:	b8 c8 0a 00 00       	mov    $0xac8,%eax
...
free(void *ap)
{
 ...
 911:	a1 74 0d 00 00       	mov    0xd74,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 967:	89 08                	mov    %ecx,(%eax)
  freep = p;
 969:	a3 74 0d 00 00       	mov    %eax,0xd74
}
 96e:	5b                   	pop    %ebx
 96f:	5e                   	pop    %esi
 970:	5f                   	pop    %edi
 ...
 98a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 98d:	a3 74 0d 00 00       	mov    %eax,0xd74
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 9a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 9ac:	8b 15 74 0d 00 00    	mov    0xd74,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 9ff:	76 3f                	jbe    a40 <malloc+0xa0>
    ...
    if(p == freep)
 a01:	39 05 74 0d 00 00    	cmp    %eax,0xd74
 ...
 a26:	e8 e5 fe ff ff       	call   910 <free>
  return freep;
 a2b:	8b 15 74 0d 00 00    	mov    0xd74,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 a4c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 a4f:	89 15 74 0d 00 00    	mov    %edx,0xd74
      return (void*)(p + 1);
 ...
 a64:	eb e9                	jmp    a4f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 a66:	c7 05 74 0d 00 00 78 	movl   $0xd78,0xd74
 a6d:	0d 00 00 
 a70:	c7 05 78 0d 00 00 78 	movl   $0xd78,0xd78
 a77:	0d 00 00 
    base.s.size = 0;
 a7a:	b8 78 0d 00 00       	mov    $0xd78,%eax
 a7f:	c7 05 7c 0d 00 00 00 	movl   $0x0,0xd7c
 a86:	00 00 00 
