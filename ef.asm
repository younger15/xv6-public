...
int main(int argc, char *argv[])
{
  ...
  1e:	ff 73 08             	pushl  0x8(%ebx)
  21:	e8 fa 00 00 00       	call   120 <strcmp>
  26:	83 c4 10             	add    $0x10,%esp
  29:	85 c0                	test   %eax,%eax
  2b:	75 51                	jne    7e <main+0x7e>
	{
  ...
  34:	e8 39 03 00 00       	call   372 <open>
		if(fd >= 0)
...
int main(int argc, char *argv[])
{
  ...
  3e:	89 c3                	mov    %eax,%ebx
		if(fd >= 0)
  40:	78 37                	js     79 <main+0x79>
		{
			char buf[1024];
			int n = read(fd, buf, sizeof buf);
  42:	8d b5 e8 fb ff ff    	lea    -0x418(%ebp),%esi
  48:	50                   	push   %eax
  49:	68 00 04 00 00       	push   $0x400
  4e:	56                   	push   %esi
  4f:	53                   	push   %ebx
  50:	e8 f5 02 00 00       	call   34a <read>
			if(n >= 0)
  55:	83 c4 10             	add    $0x10,%esp
  58:	85 c0                	test   %eax,%eax
  5a:	78 11                	js     6d <main+0x6d>
			{
				printf(1,"%s\n", buf);
  5c:	50                   	push   %eax
  5d:	56                   	push   %esi
  5e:	68 c3 07 00 00       	push   $0x7c3
  63:	6a 01                	push   $0x1
  ...
  70:	53                   	push   %ebx
  71:	e8 e4 02 00 00       	call   35a <close>
  76:	83 c4 10             	add    $0x10,%esp
	...
	exit();
  79:	e8 b4 02 00 00       	call   332 <exit>
				printf(1,"%s\n", buf);
			}
			close(fd);
		}	
  ...
  7e:	51                   	push   %ecx
  7f:	51                   	push   %ecx
  80:	68 c7 07 00 00       	push   $0x7c7
  85:	ff 73 08             	pushl  0x8(%ebx)
  88:	e8 93 00 00 00       	call   120 <strcmp>
  8d:	83 c4 10             	add    $0x10,%esp
  90:	85 c0                	test   %eax,%eax
  92:	75 e5                	jne    79 <main+0x79>
	{
		fd = open(argv[1], O_RDWR);
  94:	52                   	push   %edx
  95:	52                   	push   %edx
  96:	6a 02                	push   $0x2
  98:	ff 73 04             	pushl  0x4(%ebx)
  9b:	e8 d2 02 00 00       	call   372 <open>
		if(fd >= 0)
  ...
  a5:	89 c6                	mov    %eax,%esi
		if(fd >= 0)
  a7:	78 d0                	js     79 <main+0x79>
		{
			//if(strlen(argv[3]) > 0)
			//{
				int n = write(fd, argv[3], strlen(argv[3]) + 1);
  a9:	83 ec 0c             	sub    $0xc,%esp
  ac:	ff 73 0c             	pushl  0xc(%ebx)
  af:	e8 bc 00 00 00       	call   170 <strlen>
  b4:	83 c4 0c             	add    $0xc,%esp
  b7:	83 c0 01             	add    $0x1,%eax
  ba:	50                   	push   %eax
  bb:	ff 73 0c             	pushl  0xc(%ebx)
  be:	56                   	push   %esi
  bf:	e8 8e 02 00 00       	call   352 <write>
				if(n >= 0)
  c4:	83 c4 10             	add    $0x10,%esp
  c7:	85 c0                	test   %eax,%eax
  c9:	78 11                	js     dc <main+0xdc>
				{
					printf(1,"File update succeed\n");
  cb:	50                   	push   %eax
  cc:	50                   	push   %eax
  cd:	68 ca 07 00 00       	push   $0x7ca
  d2:	6a 01                	push   $0x1
  ...
  df:	56                   	push   %esi
  e0:	e8 75 02 00 00       	call   35a <close>
  e5:	83 c4 10             	add    $0x10,%esp
  e8:	eb 8f                	jmp    79 <main+0x79>
  ea:	66 90                	xchg   %ax,%ax
  ec:	66 90                	xchg   %ax,%ax
  ee:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 43f:	f7 f6                	div    %esi
 441:	0f b6 92 e8 07 00 00 	movzbl 0x7e8(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5b8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5bb:	b8 df 07 00 00       	mov    $0x7df,%eax
...
free(void *ap)
{
 ...
 697:	89 08                	mov    %ecx,(%eax)
  freep = p;
 699:	a3 88 0a 00 00       	mov    %eax,0xa88
}
 69e:	5b                   	pop    %ebx
 69f:	5e                   	pop    %esi
 6a0:	5f                   	pop    %edi
 ...
 6ba:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6bd:	a3 88 0a 00 00       	mov    %eax,0xa88
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 72f:	76 3f                	jbe    770 <malloc+0xa0>
    ...
    if(p == freep)
 731:	39 05 88 0a 00 00    	cmp    %eax,0xa88
 ...
 756:	e8 e5 fe ff ff       	call   640 <free>
  return freep;
 75b:	8b 15 88 0a 00 00    	mov    0xa88,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 77c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 77f:	89 15 88 0a 00 00    	mov    %edx,0xa88
      return (void*)(p + 1);
 ...
 794:	eb e9                	jmp    77f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 796:	c7 05 88 0a 00 00 8c 	movl   $0xa8c,0xa88
 79d:	0a 00 00 
 7a0:	c7 05 8c 0a 00 00 8c 	movl   $0xa8c,0xa8c
 7a7:	0a 00 00 
    base.s.size = 0;
 7aa:	b8 8c 0a 00 00       	mov    $0xa8c,%eax
 7af:	c7 05 90 0a 00 00 00 	movl   $0x0,0xa90
 7b6:	00 00 00 
