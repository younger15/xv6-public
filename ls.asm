...
ls(char *path)
{
 ...
 104:	56                   	push   %esi
 105:	53                   	push   %ebx
 106:	81 ec 24 03 00 00    	sub    $0x324,%esp
 ...
 11c:	0f 88 9e 01 00 00    	js     2c0 <ls+0x1c0>
  ...
  if(fstat(fd, &st) < 0){
 122:	8d b5 14 fd ff ff    	lea    -0x2ec(%ebp),%esi
 ...
 139:	0f 88 c1 01 00 00    	js     300 <ls+0x200>
  ...
  switch(st.type){
 13f:	0f b7 85 14 fd ff ff 	movzwl -0x2ec(%ebp),%eax
 ...
 155:	8b 95 24 fd ff ff    	mov    -0x2dc(%ebp),%edx
 15b:	8b b5 1c fd ff ff    	mov    -0x2e4(%ebp),%esi
 161:	57                   	push   %edi
 162:	89 95 f4 fc ff ff    	mov    %edx,-0x30c(%ebp)
 168:	e8 f3 fe ff ff       	call   60 <fmtname>
 16d:	8b 95 f4 fc ff ff    	mov    -0x30c(%ebp),%edx
 173:	59                   	pop    %ecx
 174:	5f                   	pop    %edi
 175:	52                   	push   %edx
 176:	56                   	push   %esi
 ...
 1c3:	57                   	push   %edi
 1c4:	8d bd 04 fd ff ff    	lea    -0x2fc(%ebp),%edi
 1ca:	50                   	push   %eax
 ...
 1ea:	8d 84 05 e9 fd ff ff 	lea    -0x217(%ebp,%eax,1),%eax
    ...
    strcpy(buf, path);
    p = buf+strlen(buf);
 1f1:	89 8d e8 fc ff ff    	mov    %ecx,-0x318(%ebp)
    *p++ = '/';
 1f7:	89 85 e4 fc ff ff    	mov    %eax,-0x31c(%ebp)
 ...
 212:	0f 85 71 ff ff ff    	jne    189 <ls+0x89>
      if(de.inum == 0)
 218:	66 83 bd 04 fd ff ff 	cmpw   $0x0,-0x2fc(%ebp)
 21f:	00 
 220:	74 de                	je     200 <ls+0x100>
        continue;
      memmove(p, de.name, DIRSIZ);
 222:	8d 85 06 fd ff ff    	lea    -0x2fa(%ebp),%eax
 228:	83 ec 04             	sub    $0x4,%esp
 22b:	6a 0e                	push   $0xe
 22d:	50                   	push   %eax
 22e:	ff b5 e4 fc ff ff    	pushl  -0x31c(%ebp)
 234:	e8 17 03 00 00       	call   550 <memmove>
      p[DIRSIZ] = 0;
 239:	8b 85 e8 fc ff ff    	mov    -0x318(%ebp),%eax
 ...
 257:	0f 88 c3 00 00 00    	js     320 <ls+0x220>
      ...
      printf(1, "%s %d %d %d\n", fmtname(buf), st.type, st.ino, st.size);
 25d:	8b 8d 24 fd ff ff    	mov    -0x2dc(%ebp),%ecx
 263:	0f bf 85 14 fd ff ff 	movswl -0x2ec(%ebp),%eax
 26a:	83 ec 0c             	sub    $0xc,%esp
 26d:	8b 95 1c fd ff ff    	mov    -0x2e4(%ebp),%edx
 273:	89 8d ec fc ff ff    	mov    %ecx,-0x314(%ebp)
 279:	8d 8d e8 fd ff ff    	lea    -0x218(%ebp),%ecx
 27f:	89 95 f0 fc ff ff    	mov    %edx,-0x310(%ebp)
 285:	89 85 f4 fc ff ff    	mov    %eax,-0x30c(%ebp)
 28b:	51                   	push   %ecx
 28c:	e8 cf fd ff ff       	call   60 <fmtname>
 291:	5a                   	pop    %edx
 292:	8b 95 f0 fc ff ff    	mov    -0x310(%ebp),%edx
 298:	59                   	pop    %ecx
 299:	8b 8d ec fc ff ff    	mov    -0x314(%ebp),%ecx
 29f:	51                   	push   %ecx
 2a0:	52                   	push   %edx
 2a1:	ff b5 f4 fc ff ff    	pushl  -0x30c(%ebp)
 2a7:	50                   	push   %eax
