...
int main(int argc, char *argv[])
{
  ...
  20:	6a 00                	push   $0x0
  22:	68 10 08 00 00       	push   $0x810
  27:	e8 96 03 00 00       	call   3c2 <open>
	//char *targetUser = argv[1];
	//printf(1,"user: %s\n", targetUser);
	//char nameList[128];
	//char *names = nameList;
...
int main(int argc, char *argv[])
{
  ...
  36:	53                   	push   %ebx
  37:	50                   	push   %eax
  38:	e8 5d 03 00 00       	call   39a <read>
	close(fd);
  ...
  40:	89 85 e4 fb ff ff    	mov    %eax,-0x41c(%ebp)
	close(fd);
  46:	e8 5f 03 00 00       	call   3aa <close>
	if(checkReadFile < 0)
  4b:	8b 95 e4 fb ff ff    	mov    -0x41c(%ebp),%edx
  51:	83 c4 10             	add    $0x10,%esp
  54:	85 d2                	test   %edx,%edx
  56:	0f 88 c8 00 00 00    	js     124 <main+0x124>
  ...
  5f:	6a 02                	push   $0x2
  61:	68 10 08 00 00       	push   $0x810
  66:	e8 57 03 00 00       	call   3c2 <open>
		if(fd >= 0)
  ...
  70:	89 85 e0 fb ff ff    	mov    %eax,-0x420(%ebp)
		if(fd >= 0)
  76:	0f 88 91 00 00 00    	js     10d <main+0x10d>
		{
			int i = strlen(buf);
  7c:	83 ec 0c             	sub    $0xc,%esp
  7f:	53                   	push   %ebx
  80:	e8 3b 01 00 00       	call   1c0 <strlen>
			if (buf[i-1] == '\n')
  ...
  8f:	0a 
			if (buf[i-1] == '\n')
  90:	8d 70 ff             	lea    -0x1(%eax),%esi
  93:	89 fa                	mov    %edi,%edx
	{
		...
		{
			int i = strlen(buf);
  95:	0f 44 c6             	cmove  %esi,%eax
  98:	89 c6                	mov    %eax,%esi
  9a:	89 85 e4 fb ff ff    	mov    %eax,-0x41c(%ebp)
  a0:	8b 47 04             	mov    0x4(%edi),%eax
  a3:	89 f7                	mov    %esi,%edi
  ...
  b7:	88 0c 3b             	mov    %cl,(%ebx,%edi,1)
				i++;
  ba:	83 c7 01             	add    $0x1,%edi
		{
			int i = strlen(buf);
			if (buf[i-1] == '\n')
				i--;
  ...
  c0:	50                   	push   %eax
  c1:	e8 fa 00 00 00       	call   1c0 <strlen>
  c6:	89 f9                	mov    %edi,%ecx
  ...
  d5:	83 ec 0c             	sub    $0xc,%esp
			...
			buf[i]=':';
  d8:	c6 84 3d e8 fb ff ff 	movb   $0x3a,-0x418(%ebp,%edi,1)
  df:	3a 
			buf[i+1]= '\0';
  e0:	c6 84 3d e9 fb ff ff 	movb   $0x0,-0x417(%ebp,%edi,1)
  e7:	00 
			//printf(1,"buf: %s\n", buf);
			write(fd,buf,strlen(buf)+1);
  e8:	53                   	push   %ebx
  e9:	e8 d2 00 00 00       	call   1c0 <strlen>
  ee:	83 c4 0c             	add    $0xc,%esp
  f1:	83 c0 01             	add    $0x1,%eax
  f4:	50                   	push   %eax
  f5:	53                   	push   %ebx
  f6:	8b 9d e0 fb ff ff    	mov    -0x420(%ebp),%ebx
  fc:	53                   	push   %ebx
  fd:	e8 a0 02 00 00       	call   3a2 <write>
			close(fd);
 102:	89 1c 24             	mov    %ebx,(%esp)
 105:	e8 a0 02 00 00       	call   3aa <close>
 10a:	83 c4 10             	add    $0x10,%esp
		}
		printf(1,"User added\n");
 10d:	83 ec 08             	sub    $0x8,%esp
 110:	68 2f 08 00 00       	push   $0x82f
 115:	6a 01                	push   $0x1
 ...
 11c:	83 c4 10             	add    $0x10,%esp
	...
	exit();
 11f:	e8 5e 02 00 00       	call   382 <exit>
	char buf[1024];
	int checkReadFile = read(fd, buf,sizeof buf);
	close(fd);
	if(checkReadFile < 0)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 48f:	f7 f6                	div    %esi
 491:	0f b6 92 44 08 00 00 	movzbl 0x844(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 608:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 60b:	b8 3b 08 00 00       	mov    $0x83b,%eax
...
malloc(uint nbytes)
{
 ...
 77f:	76 3f                	jbe    7c0 <malloc+0xa0>
    ...
    if(p == freep)
 781:	39 05 e8 0a 00 00    	cmp    %eax,0xae8
 ...
 7a6:	e8 e5 fe ff ff       	call   690 <free>
  return freep;
 7ab:	8b 15 e8 0a 00 00    	mov    0xae8,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7cc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 7cf:	89 15 e8 0a 00 00    	mov    %edx,0xae8
      return (void*)(p + 1);
 ...
 7e4:	eb e9                	jmp    7cf <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7e6:	c7 05 e8 0a 00 00 ec 	movl   $0xaec,0xae8
 7ed:	0a 00 00 
 7f0:	c7 05 ec 0a 00 00 ec 	movl   $0xaec,0xaec
 7f7:	0a 00 00 
    base.s.size = 0;
 7fa:	b8 ec 0a 00 00       	mov    $0xaec,%eax
 7ff:	c7 05 f0 0a 00 00 00 	movl   $0x0,0xaf0
 806:	00 00 00 
