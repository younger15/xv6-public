...
int main(int argc, char *argv[])
{
  ...
  11:	8d bd e8 fb ff ff    	lea    -0x418(%ebp),%edi
#include "stat.h"
#include "user.h"
#include "fcntl.h"
...
int main(int argc, char *argv[])
{
  17:	81 ec a0 04 00 00    	sub    $0x4a0,%esp
  ...
  2f:	8b 73 04             	mov    0x4(%ebx),%esi
	...
	int fd = open("UserList", O_RDONLY);
  32:	89 85 64 fb ff ff    	mov    %eax,-0x49c(%ebp)
	char *targetUser = argv[1];
	//printf(1,"user: %s\n", targetUser);
	char nameList[128];
	//char *names = nameList;
	char buf[1024];
	int checkReadFile = read(fd, buf,sizeof buf);
  38:	68 00 04 00 00       	push   $0x400
  3d:	57                   	push   %edi
  3e:	50                   	push   %eax
  3f:	e8 16 03 00 00       	call   35a <read>
	//changeUser(argv[1]);
	if(checkReadFile < 0)
  44:	83 c4 10             	add    $0x10,%esp
  47:	85 c0                	test   %eax,%eax
  49:	0f 88 9d 00 00 00    	js     ec <main+0xec>
  4f:	31 c9                	xor    %ecx,%ecx
  51:	eb 16                	jmp    69 <main+0x69>
  53:	90                   	nop
  54:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
			...
			else
			{
				//printf(1,"n: %d\n",n);
				nameList[n]=c;
  58:	88 84 0d 68 fb ff ff 	mov    %al,-0x498(%ebp,%ecx,1)
				n++;
  ...
  66:	83 c7 01             	add    $0x1,%edi
		...
		{
			c=buf[i];		
  69:	0f b6 07             	movzbl (%edi),%eax
			i++;
			
			if(c==':')
  6c:	3c 3a                	cmp    $0x3a,%al
  ...
  72:	74 35                	je     a9 <main+0xa9>
  74:	0f b6 06             	movzbl (%esi),%eax
  77:	84 c0                	test   %al,%al
  79:	74 55                	je     d0 <main+0xd0>
  7b:	38 85 68 fb ff ff    	cmp    %al,-0x498(%ebp)
  81:	75 4d                	jne    d0 <main+0xd0>
  83:	83 e9 01             	sub    $0x1,%ecx
  86:	31 c0                	xor    %eax,%eax
  88:	eb 1b                	jmp    a5 <main+0xa5>
  8a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  90:	0f b6 54 06 01       	movzbl 0x1(%esi,%eax,1),%edx
  95:	84 d2                	test   %dl,%dl
  97:	74 37                	je     d0 <main+0xd0>
  99:	83 c0 01             	add    $0x1,%eax
  9c:	3a 94 05 68 fb ff ff 	cmp    -0x498(%ebp,%eax,1),%dl
  a3:	75 2b                	jne    d0 <main+0xd0>
  a5:	39 c8                	cmp    %ecx,%eax
  ...
  ac:	ff 73 04             	pushl  0x4(%ebx)
  af:	e8 3e 03 00 00       	call   3f2 <changeUser>
  ...
  ba:	ff b5 64 fb ff ff    	pushl  -0x49c(%ebp)
  c0:	e8 a5 02 00 00       	call   36a <close>
	exit();
  c5:	e8 78 02 00 00       	call   342 <exit>
  ca:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  d0:	31 c9                	xor    %ecx,%ecx
  d2:	eb 92                	jmp    66 <main+0x66>
  ...
  db:	68 ef 07 00 00       	push   $0x7ef
  e0:	6a 01                	push   $0x1
  e2:	e8 c9 03 00 00       	call   4b0 <printf>
  e7:	83 c4 10             	add    $0x10,%esp
  ea:	eb cb                	jmp    b7 <main+0xb7>
	char buf[1024];
	int checkReadFile = read(fd, buf,sizeof buf);
	//changeUser(argv[1]);
	if(checkReadFile < 0)
  ...
  ec:	50                   	push   %eax
  ed:	50                   	push   %eax
  ee:	68 d9 07 00 00       	push   $0x7d9
  f3:	6a 01                	push   $0x1
  f5:	e8 b6 03 00 00       	call   4b0 <printf>
  fa:	83 c4 10             	add    $0x10,%esp
  fd:	eb b8                	jmp    b7 <main+0xb7>
  ff:	90                   	nop
...
putc(int fd, char c)
{
 ...
 5c8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5cb:	b8 ff 07 00 00       	mov    $0x7ff,%eax
...
free(void *ap)
{
 ...
 651:	a1 ac 0a 00 00       	mov    0xaac,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 6ca:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6cd:	a3 ac 0a 00 00       	mov    %eax,0xaac
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ec:	8b 15 ac 0a 00 00    	mov    0xaac,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 78c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 78f:	89 15 ac 0a 00 00    	mov    %edx,0xaac
      return (void*)(p + 1);
 ...
 7a4:	eb e9                	jmp    78f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7a6:	c7 05 ac 0a 00 00 b0 	movl   $0xab0,0xaac
 7ad:	0a 00 00 
 7b0:	c7 05 b0 0a 00 00 b0 	movl   $0xab0,0xab0
 7b7:	0a 00 00 
    base.s.size = 0;
 7ba:	b8 b0 0a 00 00       	mov    $0xab0,%eax
 7bf:	c7 05 b4 0a 00 00 00 	movl   $0x0,0xab4
 7c6:	00 00 00 
